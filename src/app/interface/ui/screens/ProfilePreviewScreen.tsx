...
export function ProfilePreviewScreen({ onBack, onNext }: ProfilePreviewScreenProps) {
  ...
  return (
    <div className="relative flex min-h-screen flex-col mt-3">
      <PastelBackground />
        ...
        >
          {layouts.map((layout, index) => {
            ...
            return (
              ...
              >
                <div className="mx-auto max-w-sm transition-all duration-300" style={dynamicStyle}>
                                ...
                                <div className="space-y-2 w-full max-w-[70px] flex-shrink-0">
                                  ...
                                  <div className="flex flex-col items-center gap-1">
                                    ...
                                    <input
                                      ...
                                      value={
                                        gradientColor1.startsWith("#") ? gradientColor1 : "#FFFFFF"
                                      }
                                ...
                                <div className="space-y-2 w-full max-w-[70px] flex-shrink-0">
                                  ...
                                  <div className="flex flex-col items-center gap-1">
                                    ...
                                    <input
                                      ...
                                      value={
                                        gradientColor2.startsWith("#") ? gradientColor2 : "#000000"
                                      }
