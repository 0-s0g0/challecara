  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-[#f2f2ed]  dark:bg-[#48494f]">
      ...
      <div className="absolute inset-0 top-6 flex items-start justify-center">
        <div
          className="text-amber-950/70 dark:text-gray-300 flex items-end"
      ...
      <div className="absolute -left-24 top-80 h-[240px] w-[240px] rounded-full bg-gradient-to-br  from-[#FF442C] to-[#BAD56E] opacity-30" />
      ...
      <div className="absolute -right-32 bottom-0 h-[400px] w-[400px] rounded-full bg-gradient-to-br from-[#FF442C] to-[#BAD56E] opacity-30" />
